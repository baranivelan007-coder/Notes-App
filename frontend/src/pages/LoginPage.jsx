      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            className="w-full px-4 py-3 rounded-full bg-transparent text-slate-100 border border-slate-700 placeholder-slate-400 outline-none focus:border-slate-500"
          />
          <input
            type="password"
